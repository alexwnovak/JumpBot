// Type: WindowsInput.IKeyboardSimulator
...
namespace JumpBot.Input
{
   ...
   public interface IKeyboardSimulator
   {
      ...
      /// 
      /// </summary>
      /// <param name="modifierKeyCodes">The list of <see cref="T:WindowsInput.Native.VirtualKeyCode"/>s for the modifier keys.</param><param name="keyCodes">The list of <see cref="T:WindowsInput.Native.VirtualKeyCode"/>s for the keys to simulate.</param>
      ...
      /// 
      /// </summary>
      /// <param name="modifierKeyCodes">The list of <see cref="T:WindowsInput.Native.VirtualKeyCode"/>s for the modifier keys.</param><param name="keyCode">The <see cref="T:WindowsInput.Native.VirtualKeyCode"/> for the key.</param>
      ...
      /// 
      /// </summary>
      /// <param name="modifierKey">The <see cref="T:WindowsInput.Native.VirtualKeyCode"/> for the modifier key.</param><param name="keyCodes">The list of <see cref="T:WindowsInput.Native.VirtualKeyCode"/>s for the keys to simulate.</param>
      ...
      /// 
      /// </summary>
      /// <param name="modifierKeyCode">The <see cref="T:WindowsInput.Native.VirtualKeyCode"/> for the  modifier key.</param><param name="keyCode">The <see cref="T:WindowsInput.Native.VirtualKeyCode"/> for the key.</param>
